...
import {KeyRound, Landmark, LayoutDashboard, LogOut, ShieldCheck, Users, MonitorSmartphone, UserRound} from "lucide-react";
import {clearTokens} from "@/lib/api";
import {Logo} from "./Logo";
const links = [{href:"/dashboard",label:"Overview",icon:LayoutDashboard},{href:"/settings/profile",label:"Profile",icon:UserRound},{href:"/settings/brokers",label:"Broker accounts",icon:Landmark},{href:"/settings/api-keys",label:"API keys",icon:KeyRound},{href:"/settings/security",label:"Security",icon:ShieldCheck},{href:"/settings/sessions",label:"Sessions",icon:MonitorSmartphone},{href:"/admin/users",label:"Admin",icon:Users}];
